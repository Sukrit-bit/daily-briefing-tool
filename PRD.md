...
**Scanning and reading are different activities with different time budgets.** Some mornings I have 30 seconds. Some mornings I have 10 minutes. The original design handled this with a two-layer approach: a headline index for scanning, then detail cards for reading. In practice, the headline index didn't work. Titles and metadata alone don't help you triage — you need at least an opinion about each item. User feedback was blunt: "I skip it entirely." So V16 removed it.

**The 30-second scan is now just a header** — tier count badges (how many deep dives, how many worth-a-looks, how many you can skip) and an editorial intro that synthesizes the day's themes into 1-2 sentences. 15 individual items don't tell you what's *happening*. The header tells you what kind of day it is and what connects the pieces.

**The real redesign is in the cards.** Earlier, each tier had a different *amount* of information but looked structurally the same. Now they look fundamentally different — you can tell a deep dive from a summary sufficient item without reading a word. This is a product decision, not a formatting one. If the tier system is the most important idea in the product, the email should make tiers *visible*, not just labeled.

**Deep dives** get the richest treatment: a full summary, key insights, an opinionated "so what" callout, plain-language explanations of technical terms, and a link to the original with duration. Everything you need to decide whether to block 20 minutes.

**Worth a look** items are lighter: a shorter summary, fewer insights, an inline take instead of a callout box, and a link. The visual weight says "solid, well-summarized, click through if something catches your eye."

**Summary sufficient** items are the biggest change. They show the title, source, date, and one opinionated take — nothing else. No summary. No insights. No link. The take *is* the value. Including a link would imply "there's more worth seeing in the original." For these items, there isn't. The missing link is the product saying: "You're done. Move on."

**Content type badges** — "Interview," "Market Call," "Analysis" — appear on every card. Knowing the *format* of content matters for triage. A 90-minute interview requires a different commitment than a 5-minute news analysis, even at the same tier. And older-but-good content is labeled "Evergreen" instead of "Backlog" — because reframing it as timeless rather than overdue changes whether you engage with it.
